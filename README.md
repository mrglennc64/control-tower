...
## Roadmap (deferred)
Engineering Workboard, Company Entities, Financial Snapshot, Document Vault, Timeline/Gantt. The section list mirrors PAM's `dashboard/` markdown. (Deadlines & Reminders shipped as the first v2 module.)
